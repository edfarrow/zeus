...
//            parser = new Mock<IUrlParser>().Object;

//            var typeFinder = CreateTypeFinder();
//            var builder = new ContentTypeBuilder(typeFinder);
...
//        private static ITypeFinder CreateTypeFinder()
//        {
//            var typeFinderMock = new Mock<ITypeFinder>();
//            typeFinderMock.Setup(m => m.Find(typeof(ContentItem))).Returns(new[]
//            {
